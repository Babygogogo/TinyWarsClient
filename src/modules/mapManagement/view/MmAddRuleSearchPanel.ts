...
namespace TwnsMmAddRuleSearchPanel {
    import LangTextType     = TwnsLangTextType.LangTextType;
    import NotifyType       = TwnsNotifyType.NotifyType;

    export type OpenData = void;
    export class MmAddRuleSearchPanel extends TwnsUiPanel.UiPanel<OpenData> {
        ...
        private _onTouchedBtnReset(): void {
            TwnsPanelManager.open(TwnsPanelConfig.Dict.MmAddRuleMapListPanel, {});
            this.close();
        }
...
// export default TwnsMmAddRuleSearchPanel;
