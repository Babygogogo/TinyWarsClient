...
namespace TwnsMfwWarBasicSettingsPage {
    ...
    export class MfwWarBasicSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForMfwWarBasicSettingsPage> {
...
export default TwnsMfwWarBasicSettingsPage;
