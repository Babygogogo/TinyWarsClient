...
namespace Twns.HalfwayReplayWar {
    ...
    export type OpenDataForHrwReplayProgressPanel = {
        war: Twns.HalfwayReplayWar.HrwWar;
    };
    export class HrwReplayProgressPanel extends TwnsUiPanel.UiPanel<OpenDataForHrwReplayProgressPanel> {
        ...
        private _updateLabelTarget(): void {
            const checkpointInfo        = Twns.Helpers.getExisted(this._allCheckpointInfoArray, ClientErrorCode.HrwReplayProgressPanel_UpdateGroupProgress_00)[this._getSelectedCheckpointId()];
        ...
        private _getSelectedCheckpointId(): number {
            return Twns.Helpers.getExisted(this._selectedCheckpointId, ClientErrorCode.HrwReplayProgressPanel_GetSelectedCheckpointId_00);
        }
        ...
        private _getMaxCheckpointId(): number {
            return Twns.Helpers.getExisted(this._allCheckpointInfoArray?.length, ClientErrorCode.HrwReplayProgressPanel_GetMaxCheckpointId_00) - 1;
        }
