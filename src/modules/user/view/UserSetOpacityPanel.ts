...
namespace TwnsUserSetOpacityPanel {
    import NotifyType       = TwnsNotifyType.NotifyType;
    import LangTextType     = TwnsLangTextType.LangTextType;

    export type OpenData = void;
    export class UserSetOpacityPanel extends TwnsUiPanel.UiPanel<OpenData> {
        ...
        protected async _updateOnOpenDataChanged(): Promise<void> {
            this._prevOpacitySettings = Helpers.deepClone(UserModel.getSelfSettingsOpacitySettings()) ?? {};
        ...
        private _onTouchedGroupUnitOpacity(e: egret.Event): void {
            ...
            UserModel.setSelfSettingsOpacitySettings(opacitySettings);
        ...
        private _onTouchedBtnCancel(): void {
            UserModel.setSelfSettingsOpacitySettings(this._prevOpacitySettings);
            this.close();
        }
        private _onTouchedBtnDefault(): void {
            UserModel.setSelfSettingsOpacitySettings({
                unitOpacity             : 100,
                tileBaseOpacity         : 100,
        ...
        private _updateGroupUnitOpacity(): void {
            const opacity               = UserModel.getSelfSettingsOpacitySettings()?.unitOpacity ?? 100;
        ...
        private _updateGroupTileBaseOpacity(): void {
            const opacity                   = UserModel.getSelfSettingsOpacitySettings()?.tileBaseOpacity ?? 100;
        ...
        private _updateGroupTileObjectOpacity(): void {
            const opacity                       = UserModel.getSelfSettingsOpacitySettings()?.tileObjectOpacity ?? 100;
        ...
        private _updateGroupTileDecoratorOpacity(): void {
            const opacity                           = UserModel.getSelfSettingsOpacitySettings()?.tileDecoratorOpacity ?? 100;
