...
namespace TinyWars.CoopCustomRoom {
    ...
    export class CcrRoomInfoPanel extends GameUi.UiPanel<OpenDataForCcrRoomInfoPanel> {
        ...
        private readonly _tabSettings           : GameUi.UiTab<DataForTabItemRenderer, OpenDataForCcrRoomMapInfoPage | OpenDataForCcrRoomPlayerInfoPage | OpenDataForCcrRoomBasicSettingsPage | OpenDataForCcrRoomAdvancedSettingsPage>;
        ...
        private readonly _btnStartGame          : GameUi.UiButton;
        private readonly _btnDeleteRoom         : GameUi.UiButton;
        ...
        private async _initSclPlayerIndex(): Promise<void> {
            const roomId                = this._getOpenData().roomId;
            const roomInfo              = await CcrModel.getRoomInfo(roomId);
            const playersCountUnneutral = roomInfo ? (await WarMap.WarMapModel.getRawData(roomInfo.settingsForCcw.mapId)).playersCountUnneutral : null;
