...
namespace TwnsCcrRoomAdvancedSettingsPage {
    ...
    export class CcrRoomAdvancedSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForCcrRoomAdvancedSettingsPage> {
...
export default TwnsCcrRoomAdvancedSettingsPage;
