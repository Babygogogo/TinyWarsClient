...
namespace TwnsCcrRoomBasicSettingsPage {
    ...
    export class CcrRoomBasicSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForCcrRoomBasicSettingsPage> {
...
export default TwnsCcrRoomBasicSettingsPage;
