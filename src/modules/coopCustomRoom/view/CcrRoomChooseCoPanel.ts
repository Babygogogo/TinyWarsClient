...
namespace TwnsCcrRoomChooseCoPanel {
    ...
    export class CcrRoomChooseCoPanel extends TwnsUiPanel.UiPanel<OpenDataForCcrRoomChooseCoPanel> {
...
export default TwnsCcrRoomChooseCoPanel;
