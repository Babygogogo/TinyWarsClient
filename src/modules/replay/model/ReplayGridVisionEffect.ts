...
namespace TinyWars.Replay {
    ...
    export class ReplayGridVisionEffect {
        private _view: ReplayGridVisionEffectView;
        ...
        public async init(): Promise<ReplayGridVisionEffect> {
            this._view = this._view || new ReplayGridVisionEffectView();
        ...
        public getView(): ReplayGridVisionEffectView {
            return this._view;
        }
