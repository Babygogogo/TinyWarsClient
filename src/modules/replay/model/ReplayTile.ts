...
namespace TinyWars.Replay {
    ...
    export class ReplayTile {
        ...
        private _view           : ReplayTileView;
        private _isFogEnabled   : boolean;

        public constructor() {
        }

        public init(data: SerializedMcwTile, configVersion: number): ReplayTile {
            ...
            this._view = this._view || new ReplayTileView();
        ...
        public getDefenseAmountForUnit(unit: ReplayUnit): number {
        ...
        public checkCanDefendUnit(unit: ReplayUnit): boolean {
        ...
        public getMoveCostByUnit(unit: ReplayUnit): number | undefined | null {
        ...
        private _checkCanRepairUnit(unit: ReplayUnit): boolean {
        ...
        public checkCanSupplyUnit(unit: ReplayUnit): boolean {
            const category = this.getRepairUnitCategory();
            return (category != null)
        ...
        public getRepairHpAndCostForUnit(unit: ReplayUnit): Types.RepairHpAndCost | undefined {
