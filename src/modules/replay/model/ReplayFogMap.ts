...
namespace TinyWars.Replay {
    ...
    export class ReplayFogMap {
        ...
        public async init(data: SerializedMcFogMap, mapIndexKey: Types.MapIndexKey): Promise<ReplayFogMap> {
        ...
        public updateMapFromPathsByUnitAndPath(unit: ReplayUnit, path: GridIndex[]): void {
        ...
        public getVisibilityForTeam(gridIndex: GridIndex, teamIndex: number): Visibility {
            if (!this.checkHasFogCurrently()) {
                ...
                this._war.getPlayerManager().forEachPlayer(false, (player: ReplayPlayer) => {
