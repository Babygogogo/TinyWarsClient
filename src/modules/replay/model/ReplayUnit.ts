...
namespace TinyWars.Replay {
    ...
    export class ReplayUnit {
        ...
        public init(data: SerializedMcUnit, configVersion: number): ReplayUnit {
            ...
            this._view = this._view || new ReplayUnitView();
        ...
        public getWar(): ReplayWar | undefined {
            return this._war;
        }
        ...
        public checkCanCaptureTile(tile: ReplayTile): boolean {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        public checkCanLaunchSiloOnTile(tile: ReplayTile): boolean {
        ...
        public checkCanBuildOnTile(tile: ReplayTile): boolean {
        ...
        public getLoadedUnits(): ReplayUnit[] {
        ...
        public checkCanLoadUnit(unit: ReplayUnit): boolean {
        ...
        private _checkCanRepairLoadedUnit(unit: ReplayUnit): boolean {
        ...
        public getLoaderUnit(): ReplayUnit | undefined {
        ...
        public getRepairHpAndCostForLoadedUnit(unit: ReplayUnit): Types.RepairHpAndCost | undefined {
        ...
        public checkCanSupplyAdjacentUnit(unit: ReplayUnit): boolean {
        ...
        // Functions for join.
        ////////////////////////////////////////////////////////////////////////////////
        public checkCanJoinUnit(unit: ReplayUnit): boolean {
            return (this !== unit)
        ...
        public getJoinIncome(unit: ReplayUnit): number | undefined {
