...
namespace TinyWars.Replay {
    ...
    export class ReplayUnitView extends egret.DisplayObjectContainer {
        ...
        public init(unit: ReplayUnit): ReplayUnitView {
            this._unit = unit;

            return this;
        }

        public startRunningView(): ReplayUnitView {
            this.resetAllViews();

            return this;
        }

        public getUnit(): ReplayUnit {
            return this._unit;
        }
