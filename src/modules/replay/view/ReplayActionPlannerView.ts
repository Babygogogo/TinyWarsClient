...
namespace TinyWars.Replay {
    ...
    export class ReplayActionPlannerView extends egret.DisplayObjectContainer {
        ...
        private _focusUnitViews         = new Map<number, ReplayUnitView>();
        ...
        public init(actionPlanner: ReplayActionPlanner): void {
        ...
        // Other functions.
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        private _addUnitView(unit: ReplayUnit, gridIndex: GridIndex, alpha = 1): void {
            const view = new ReplayUnitView().init(unit).startRunningView();
            // view.alpha = alpha;
    ...
    function _resetUnitViewXy(view: ReplayUnitView, gridIndex: GridIndex): void {
