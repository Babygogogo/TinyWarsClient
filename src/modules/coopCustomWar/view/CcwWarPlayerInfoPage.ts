...
namespace TwnsCcwWarPlayerInfoPage {
    ...
    export class CcwWarPlayerInfoPage extends TwnsUiTabPage.UiTabPage<OpenDataForCcwWarPlayerInfoPage> {
        // @ts-ignore
...
export default TwnsCcwWarPlayerInfoPage;
