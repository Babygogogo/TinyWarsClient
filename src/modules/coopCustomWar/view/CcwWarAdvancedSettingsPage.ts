...
namespace TwnsCcwWarAdvancedSettingsPage {
    ...
    export class CcwWarAdvancedSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForCcwWarAdvancedSettingsPage> {
        // @ts-ignore
...
export default TwnsCcwWarAdvancedSettingsPage;
