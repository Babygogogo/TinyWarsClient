...
namespace TinyWars.ReplayWar {
    ...
    export class RwUnitBriefPanel extends GameUi.UiPanel {
        protected readonly _LAYER_TYPE   = Utility.Types.LayerType.Hud0;
        protected readonly _IS_EXCLUSIVE = false;

        private static _instance: RwUnitBriefPanel;
        ...
        public static show(): void {
            if (!RwUnitBriefPanel._instance) {
                RwUnitBriefPanel._instance = new RwUnitBriefPanel();
            }
            RwUnitBriefPanel._instance.open();
        }
        ...
        public static getInstance(): RwUnitBriefPanel {
            return RwUnitBriefPanel._instance;
        }
        ...
        public constructor() {
            ...
            this.skinName = `resource/skins/replayWar/RwUnitBriefPanel.exml`;
        }
        ...
        private _updateView(): void {
            if ((RwWarMenuPanel.getIsOpening()) || (RwCoListPanel.getIsOpening()) || (RwProduceUnitPanel.getIsOpening())) {
                this.visible = false;
            } else {
                this.visible = true;
        ...
        private _adjustPositionOnTouch(e: egret.TouchEvent): void {
            const tileBriefPanel = RwTileBriefPanel.getInstance();
    ...
    class McwUnitBriefCell extends eui.Component {
        ...
        public constructor() {
            ...
            this.skinName = `resource/skins/replayWar/RwUnitBriefCell.exml`;
        }
