...
namespace TwnsMrwWarBasicSettingsPage {
    ...
    export class MrwWarBasicSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForMrwWarBasicSettingsPage> {
...
export default TwnsMrwWarBasicSettingsPage;
