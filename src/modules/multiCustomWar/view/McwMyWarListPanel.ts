...
namespace TwnsMcwMyWarListPanel {
    ...
    export class McwMyWarListPanel extends TwnsUiPanel.UiPanel<void> {
        ...
        public static async hide(): Promise<void> {
            if (McwMyWarListPanel._instance) {
                await McwMyWarListPanel._instance.close().catch(err => { CompatibilityHelpers.showError(err); throw err; });
            }
        }
        ...
        private async _createDataForCommonWarPlayerInfoPage(): Promise<OpenDataForCommonWarPlayerInfoPage> {
            return await MpwModel.createDataForCommonWarPlayerInfoPage(MpwModel.getMcwPreviewingWarId()).catch(err => { CompatibilityHelpers.showError(err); throw err; });
        }

        private async _createDataForCommonWarBasicSettingsPage(): Promise<OpenDataForCommonWarBasicSettingsPage> {
            return await MpwModel.createDataForCommonWarBasicSettingsPage(MpwModel.getMcwPreviewingWarId()).catch(err => { CompatibilityHelpers.showError(err); throw err; });
        }

        private async _createDataForCommonWarAdvancedSettingsPage(): Promise<OpenDataForCommonWarAdvancedSettingsPage> {
            return await MpwModel.createDataForCommonWarAdvancedSettingsPage(MpwModel.getMcwPreviewingWarId()).catch(err => { CompatibilityHelpers.showError(err); throw err; });
        }
        ...
        protected async _onDataChanged(): Promise<void> {
            ...
            if (!warInfo) {
                ...
                if (warName) {
                    ...
                    const mapName   = Helpers.getExisted(await WarMapModel.getMapNameInCurrentLanguage(mapId).catch(err => { CompatibilityHelpers.showError(err); throw err; }));
