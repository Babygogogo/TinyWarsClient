...
namespace TinyWars.WarEvent {
    ...
    export class WeConditionModifyPanel8 extends GameUi.UiPanel {
        ...
        public static hide(): void {
            if (WeConditionModifyPanel8._instance) {
                WeConditionModifyPanel8._instance.close();
            }
        }
        ...
        private _onTouchedBtnType(e: egret.TouchEvent): void {
            WeConditionTypeListPanel.show({ condition: this._getOpenData<OpenDataForWeConditionModifyPanel8>().condition });
        }
        ...
        private _updateLabelDesc(): void {
            this._labelDesc.text = WarEventHelper.getDescForCondition(this._getOpenData<OpenDataForWeConditionModifyPanel8>().condition);
        }
    }
}
