...
namespace Twns.WarEvent {
    ...
    export type OpenDataForWeActionModifyPanel22 = {
        war         : BwWar;
        fullData    : IWarEventFullData;
        action      : IWarEventAction;
    };
    export class WeActionModifyPanel22 extends TwnsUiPanel.UiPanel<OpenDataForWeActionModifyPanel22> {
        ...
        private _getAction(): CommonProto.WarEvent.IWeaDeprecatedSetPlayerCoEnergy {
            return Twns.Helpers.getExisted(this._getOpenData().action.WeaDeprecatedSetPlayerCoEnergy);
        }
    }
}
