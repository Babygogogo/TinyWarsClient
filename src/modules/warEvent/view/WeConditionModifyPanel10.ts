...
namespace TinyWars.WarEvent {
    ...
    export class WeConditionModifyPanel10 extends GameUi.UiPanel {
        ...
        public static hide(): void {
            if (WeConditionModifyPanel10._instance) {
                WeConditionModifyPanel10._instance.close();
            }
        }
        ...
        private _onTouchedBtnType(e: egret.TouchEvent): void {
            WeConditionTypeListPanel.show({ condition: this._getOpenData<OpenDataForWeConditionModifyPanel10>().condition });
        }
        ...
        private _updateLabelDesc(): void {
            this._labelDesc.text = WarEventHelper.getDescForCondition(this._getOpenData<OpenDataForWeConditionModifyPanel10>().condition);
        }
    }
}
