...
namespace Twns.WarEvent {
    ...
    export type OpenDataForWeConditionModifyPanel1 = {
        war         : BaseWar.BwWar;
    ...
    export class WeConditionModifyPanel1 extends TwnsUiPanel.UiPanel<OpenDataForWeConditionModifyPanel1> {
        ...
        private _onTouchedGroupIsNot(): void {
            const data  = Twns.Helpers.getExisted(this._getCondition().WecTurnIndexEqualTo);
        ...
        private _onFocusOutInputTurnIndex(): void {
            ...
            if (isNaN(value)) {
                ...
                Twns.Helpers.getExisted(this._getCondition().WecTurnIndexEqualTo).valueEqualTo = value;
                this._updateLabelDescAndLabelError();
                this._updateInputTurnIndex();
                Notify.dispatch(NotifyType.WarEventFullDataChanged);
            }
