...
namespace TwnsWeConditionModifyPanel3 {
    ...
    export class WeConditionModifyPanel3 extends TwnsUiPanel.UiPanel<OpenDataForWeConditionModifyPanel3> {
        ...
        public static async hide(): Promise<void> {
            if (WeConditionModifyPanel3._instance) {
                await WeConditionModifyPanel3._instance.close().catch(err => { CompatibilityHelpers.showError(err); throw err; });
            }
        }
        ...
        private _onTouchedGroupIsNot(): void {
            const data  = Helpers.getExisted(this._getCondition().WecTurnIndexLessThan);
        ...
        private _onFocusOutInputTurnIndex(): void {
            ...
            if (isNaN(value)) {
                ...
                Helpers.getExisted(this._getCondition().WecTurnIndexLessThan).valueLessThan = value;
                this._updateLabelDescAndLabelError();
                this._updateInputTurnIndex();
                Notify.dispatch(NotifyType.WarEventFullDataChanged);
            }
...
export default TwnsWeConditionModifyPanel3;
