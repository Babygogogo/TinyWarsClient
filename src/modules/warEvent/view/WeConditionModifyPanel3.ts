...
namespace TinyWars.WarEvent {
    ...
    export class WeConditionModifyPanel3 extends GameUi.UiPanel {
        ...
        public static hide(): void {
            if (WeConditionModifyPanel3._instance) {
                WeConditionModifyPanel3._instance.close();
            }
        }
        ...
        private _getCondition(): IWarEventCondition {
            return this._getOpenData<OpenDataForWeConditionModifyPanel3>().condition;
        }
    }
}
