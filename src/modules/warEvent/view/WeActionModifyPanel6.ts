...
namespace TwnsWeActionModifyPanel6 {
    ...
    type OpenDataForWeActionModifyPanel6 = {
        war         : BwWar;
    ...
    export class WeActionModifyPanel6 extends TwnsUiPanel.UiPanel<OpenDataForWeActionModifyPanel6> {
        ...
        private static _instance: WeActionModifyPanel6;
        ...
        public static show(openData: OpenDataForWeActionModifyPanel6): void {
            if (!WeActionModifyPanel6._instance) {
                WeActionModifyPanel6._instance = new WeActionModifyPanel6();
            }
            WeActionModifyPanel6._instance.open(openData);
        }
        public static async hide(): Promise<void> {
            if (WeActionModifyPanel6._instance) {
                await WeActionModifyPanel6._instance.close();
            }
        }
        ...
        public constructor() {
            ...
            this.skinName = "resource/skins/warEvent/WeActionModifyPanel6.exml";
        }
        ...
        private _onTouchedBtnAddDialogue(): void {
            ...
            if (dialogueArray.length > CommonConstants.WarEventActionDialogueMaxCount) {
                ...
                dialogueArray.push(WarEventHelper.getDefaultSimpleCoDialogueData());
        ...
        private _onTouchedBtnPlay(): void {
            ...
            TwnsBwSimpleDialoguePanel.BwSimpleDialoguePanel.show({
    ...
    type DataForDialogueRenderer = {
        war             : BwWar;
        action          : IWarEventAction;
        dataForDialogue : ProtoTypes.WarEvent.WeaSimpleDialogue.IDataForDialogue;
    };
    class DialogueRenderer extends TwnsUiListItemRenderer.UiListItemRenderer<DataForDialogueRenderer> {
        ...
        private _onTouchedBtnInsert(): void {
            ...
            if (dialogueArray.length > CommonConstants.WarEventActionDialogueMaxCount) {
                ...
                dialogueArray.splice(dialogueArray.indexOf(data.dataForDialogue), 0, WarEventHelper.getDefaultSimpleCoDialogueData());
                Notify.dispatch(NotifyType.WarEventFullDataChanged);
            }
        }
