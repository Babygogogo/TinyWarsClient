...
namespace Twns.WarEvent {
    ...
    export type OpenDataForWeConditionModifyPanel20 = {
        war         : BaseWar.BwWar;
        fullData    : IWarEventFullData;
        condition   : IWarEventCondition;
    };
    /** WecEventCalledCountTotalEqualTo */
    export class WeConditionModifyPanel20 extends TwnsUiPanel.UiPanel<OpenDataForWeConditionModifyPanel20> {
        ...
        private _onTouchedGroupIsNot(): void {
            const data  = Twns.Helpers.getExisted(this._getCondition().WecEventCalledCountTotalEqualTo);
        ...
        private _onTouchedBtnTurnEvent(): void {
            ...
            const condition             = Twns.Helpers.getExisted(openData.condition.WecEventCalledCountTotalEqualTo);
        ...
        private _onFocusOutInputCalledCount(): void {
            ...
            if (isNaN(value)) {
                ...
                Twns.Helpers.getExisted(this._getCondition().WecEventCalledCountTotalEqualTo).countEqualTo = value;
                this._updateLabelDescAndLabelError();
                this._updateInputCalledCount();
                Twns.Notify.dispatch(NotifyType.WarEventFullDataChanged);
            }
        ...
        private _updateLabelEvent(): void {
            const openData          = this._getOpenData();
            const eventId           = Twns.Helpers.getExisted(openData.condition.WecEventCalledCountTotalEqualTo?.eventIdEqualTo);
