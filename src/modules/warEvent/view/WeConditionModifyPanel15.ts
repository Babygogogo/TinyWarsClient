...
namespace TwnsWeConditionModifyPanel15 {
    ...
    export class WeConditionModifyPanel15 extends TwnsUiPanel.UiPanel<OpenData> {
        ...
        private _onTouchedBtnPlayerIndex(): void {
            const openData  = this._getOpenData();
            const condition = Helpers.getExisted(openData.condition.WecUnitPresence);
        ...
        private _onTouchedBtnTeamIndex(): void {
            ...
            TwnsPanelManager.open(TwnsPanelConfig.Dict.CommonChooseTeamIndexPanel, {
                ...
                maxTeamIndex            : openData.war.getPlayersCountUnneutral(),
        ...
        private _onTouchedBtnUnitType(): void {
            const condition = Helpers.getExisted(this._getOpenData().condition.WecUnitPresence);
        ...
        private _onTouchedBtnGridIndex(): void {
            ...
            TwnsPanelManager.open(TwnsPanelConfig.Dict.CommonChooseGridIndexPanel, {
                ...
                mapSize                 : openData.war.getTileMap().getMapSize(),
        ...
        private _onFocusOutInputUnitsCount(): void {
            ...
            if (isNaN(value)) {
                ...
                Helpers.getExisted(this._getCondition().WecUnitPresence).unitsCount = value;
                Notify.dispatch(NotifyType.WarEventFullDataChanged);
            }
        }
        ...
        private _updateLabelPlayerIndex(): void {
            const playerIndexArray      = this._getOpenData().condition.WecUnitPresence?.playerIndexArray;
        ...
        private _updateLabelTeamIndex(): void {
            const teamIndexArray        = this._getOpenData().condition.WecUnitPresence?.teamIndexArray;
        ...
        private _updateLabelUnitType(): void {
            const unitTypeArray         = this._getOpenData().condition.WecUnitPresence?.unitTypeArray;
        ...
        private _updateLabelLocation(): void {
            const locationIdArray       = this._getOpenData().condition.WecUnitPresence?.locationIdArray;
        ...
        private _updateLabelGridIndex(): void {
            const gridIndexArray        = this._getOpenData().condition.WecUnitPresence?.gridIndexArray;
        ...
        private _updateLabelUnitsCountComparator(): void {
            const comparator                        = Helpers.getExisted(this._getCondition().WecUnitPresence?.unitsCountComparator);
        ...
        private _updateInputUnitsCount(): void {
            this._inputUnitsCount.text = `${this._getCondition().WecUnitPresence?.unitsCount}`;
        }
