...
namespace Twns.WarEvent {
    ...
    export type OpenDataForWeConditionModifyPanel2 = {
        war         : BaseWar.BwWar;
    ...
    export class WeConditionModifyPanel2 extends TwnsUiPanel.UiPanel<OpenDataForWeConditionModifyPanel2> {
        ...
        private _onTouchedGroupIsNot(): void {
            const data  = Twns.Helpers.getExisted(this._getCondition().WecTurnIndexGreaterThan);
        ...
        private _onFocusOutInputTurnIndex(): void {
            ...
            if (isNaN(value)) {
                ...
                Twns.Helpers.getExisted(this._getCondition().WecTurnIndexGreaterThan).valueGreaterThan = value;
                this._updateLabelDescAndLabelError();
                this._updateInputTurnIndex();
                Twns.Notify.dispatch(NotifyType.WarEventFullDataChanged);
            }
