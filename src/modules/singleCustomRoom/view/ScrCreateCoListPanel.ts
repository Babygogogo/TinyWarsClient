...
namespace TwnsScrCreateCoListPanel {
    ...
    export class ScrCreateCoListPanel extends TwnsUiPanel.UiPanel<OpenDataForScrCreateCoListPanel> {
...
export default TwnsScrCreateCoListPanel;
