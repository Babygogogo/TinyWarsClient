...
namespace TwnsScrCreateBasicSettingsPage {
    import CommonConfirmPanel       = TwnsCommonConfirmPanel.CommonConfirmPanel;
    import CommonHelpPanel          = TwnsCommonHelpPanel.CommonHelpPanel;
    import ScrCreateSaveSlotsPanel  = TwnsScrCreateSaveSlotsPanel.ScrCreateSaveSlotsPanel;
...
export default TwnsScrCreateBasicSettingsPage;
