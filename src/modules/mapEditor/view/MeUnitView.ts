...
namespace TinyWars.MapEditor {
    ...
    export class MeUnitView extends egret.DisplayObjectContainer {
        ...
        public init(unit: MeUnit): MeUnitView {
            this._unit = unit;

            return this;
        }

        public startRunningView(): MeUnitView {
            this.resetAllViews();

            return this;
        }

        public getUnit(): MeUnit {
            return this._unit;
        }
        ...
        private _addFrameForLoader(): void {
            ...
            if ((unit.getWar()) && (unit.getMaxLoadUnitsCount()) && (unit.getLoadedUnitsCount() > 0)) {
