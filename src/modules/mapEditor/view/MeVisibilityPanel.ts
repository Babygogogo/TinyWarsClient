...
namespace TwnsMeVisibilityPanel {
    ...
    export class MeVisibilityPanel extends TwnsUiPanel.UiPanel<void> {
        ...
        private _groupTileDecorator : eui.Group;
        private _imgTileDecorator   : TwnsUiImage.UiImage;
        private _labelTileDecorator : TwnsUiLabel.UiLabel;
        ...
        private _updateGroupTileDecorator(): void {
            this._imgTileDecorator.visible = this._war.getField().getView().getTileDecoratorsVisible();
        }
