...
namespace Twns.Common {
    ...
    export type OpenDataForCommonChooseLocationPanel = {
        currentLocationIdArray  : number[];
        callbackOnConfirm       : (locationIdArray: number[]) => void;
    };
    export class CommonChooseLocationPanel extends TwnsUiPanel.UiPanel<OpenDataForCommonChooseLocationPanel> {
