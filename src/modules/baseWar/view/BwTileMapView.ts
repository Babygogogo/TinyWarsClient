...
namespace TinyWars.BaseWar {
    ...
    export abstract class BwTileMapView extends egret.DisplayObjectContainer {
        ...
        private _initCoZoneContainer(): void {
            ...
            const { mapWidth, mapHeight, playersCount } = this._tileMap.getTemplateMap();
        ...
        public updateCoZone(): void {
            ...
            const { mapWidth, mapHeight, playersCount } = tileMap.getTemplateMap();
            ...
            for (let playerIndex = 1; playerIndex <= playersCount; ++playerIndex) {
                ...
                const canShow       = (!!gridIndex) && (!player.getCoIsUsingSkill()) && (radius != null);
