...
namespace TwnsMrrRoomAdvancedSettingsPage {
    ...
    export class MrrRoomAdvancedSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForMrrRoomAdvancedSettingsPage> {
...
export default TwnsMrrRoomAdvancedSettingsPage;
