...
namespace TwnsMcrRoomChooseCoPanel {
    ...
    export class McrRoomChooseCoPanel extends TwnsUiPanel.UiPanel<OpenDataForMcrRoomChooseCoPanel> {
...
export default TwnsMcrRoomChooseCoPanel;
