...
namespace TwnsMcrRoomBasicSettingsPage {
    ...
    export class McrRoomBasicSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForMcrRoomBasicSettingsPage> {
...
export default TwnsMcrRoomBasicSettingsPage;
