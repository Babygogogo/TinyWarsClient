...
namespace TinyWars.MultiCustomRoom {
    ...
    export class McrWatchHandleRequestWarsPanel extends GameUi.UiPanel {
        ...
        protected _onOpened(): void {
            this._setNotifyListenerArray([
                ...
                { type: Notify.Type.MsgMpwWatchGetRequestedWarInfos,  callback: this._onNotifySMcwWatchGetRequestedWarInfos },
                { type: Notify.Type.MsgMpwWatchHandleRequest,         callback: this._onNotifySMcwWatchHandleRequest },
            ]);
            ...
            MultiPlayerWar.MpwProxy.reqWatchRequestedWarInfos();
        }
        ...
        private _onNotifySMcwWatchGetRequestedWarInfos(e: egret.Event): void {
            const newData        = this._createDataForListWar(MultiPlayerWar.MpwModel.getWatchRequestedWarInfos());
    ...
    class WarRenderer extends GameUi.UiListItemRenderer {
        ...
        private async _onTouchTapBtnNext(e: egret.TouchEvent): Promise<void> {
            McrWatchHandleRequestDetailPanel.show({ watchInfo: (this.data as DataForWarRenderer).info });
        }
    }
