    ...
    export class McrWatchDeleteWatcherWarsPanel extends GameUi.UiPanel {
        ...
        protected _onFirstOpened(): void {
            this._notifyListeners = [
                ...
                { type: Notify.Type.MsgMcwWatchGetWatchedWarInfos,    callback: this._onNotifySMcwWatchGetWatchedWarInfos },
                { type: Notify.Type.MsgMcwWatchDeleteWatcher,         callback: this._onNotifySMcwWatchDeleteWatcher },
            ];
            this._uiListeners = [
        ...
        protected _onOpened(): void {
            ...
            MultiCustomWar.McwProxy.reqWatchedWarInfos();
        }
        ...
        private _onNotifySMcwWatchGetWatchedWarInfos(e: egret.Event): void {
            const newData        = this._createDataForListWar(MultiCustomWar.McwModel.getWatchedWarInfos());
