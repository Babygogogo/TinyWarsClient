...
namespace TwnsMfrRoomPlayerInfoPage {
    ...
    export class MfrRoomPlayerInfoPage extends TwnsUiTabPage.UiTabPage<OpenDataForMfrRoomPlayerInfoPage> {
...
export default TwnsMfrRoomPlayerInfoPage;
