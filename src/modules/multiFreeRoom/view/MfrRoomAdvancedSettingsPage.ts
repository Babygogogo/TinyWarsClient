...
namespace TwnsMfrRoomAdvancedSettingsPage {
    ...
    export class MfrRoomAdvancedSettingsPage extends TwnsUiTabPage.UiTabPage<OpenDataForMfrRoomAdvancedSettingsPage> {
...
export default TwnsMfrRoomAdvancedSettingsPage;
