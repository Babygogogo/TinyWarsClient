...
export const enum NetErrorCode {
    ...
    MsgRmrGetMaxConcurrentCount0000,

    MsgRmrGetMyRoomPublicInfoList0000,
    MsgRmrGetMyRoomPublicInfoList0001,

    MsgRmrGetRoomPublicInfo0000,
    MsgRmrGetRoomPublicInfo0001,

    MsgRmrSetBannedCoIdList0000,
    MsgRmrSetBannedCoIdList0001,
    MsgRmrSetBannedCoIdList0002,
    MsgRmrSetBannedCoIdList0003,
    MsgRmrSetBannedCoIdList0004,
    MsgRmrSetBannedCoIdList0005,
    MsgRmrSetBannedCoIdList0006,
    MsgRmrSetBannedCoIdList0007,
    MsgRmrSetBannedCoIdList0008,
    MsgRmrSetBannedCoIdList0009,
    MsgRmrSetBannedCoIdList0010,
    MsgRmrSetBannedCoIdList0011,
    MsgRmrSetBannedCoIdList0012,
    MsgRmrSetBannedCoIdList0013,
    MsgRmrSetBannedCoIdList0014,
    MsgRmrSetBannedCoIdList0015,
    MsgRmrSetBannedCoIdList0016,

    MsgRmrSetMaxConcurrentCount0000,
    MsgRmrSetMaxConcurrentCount0001,
    MsgRmrSetMaxConcurrentCount0002,

    MsgRmrSetSelfSettings0000,
    MsgRmrSetSelfSettings0001,
    MsgRmrSetSelfSettings0002,
    MsgRmrSetSelfSettings0003,
    MsgRmrSetSelfSettings0004,
    MsgRmrSetSelfSettings0005,
    MsgRmrSetSelfSettings0006,
    MsgRmrSetSelfSettings0007,
    MsgRmrSetSelfSettings0008,
    MsgRmrSetSelfSettings0009,
    MsgRmrSetSelfSettings0010,
    MsgRmrSetSelfSettings0011,
    MsgRmrSetSelfSettings0012,
    MsgRmrSetSelfSettings0013,
    MsgRmrSetSelfSettings0014,
