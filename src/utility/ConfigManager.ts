...
namespace TinyWars.ConfigManager {
    ...
    const _TILE_BASE_SYMMETRY = new Map<number, number[]>([
        ...
        // 原图     上下翻转 顺时针90 左右翻转 逆时针90 逆时针180  // 图块变换
        ////////// plain: 1 (1 total) //////////
        [ 1,    [   1,      1,      1,      1,      1]],
    ...
    const _TILE_OBJECT_SYMMETRY = new Map<number, number[]>([
        ...
        [ 97,   [   95,     96,     97,     98,     95]],
        [ 98,   [   98,     97,     96,     95,     96]],
        [ 99,   [   101,    102,    99,     100,    101]],
        [ 100,  [   100,    99,     102,    101,    102]],
        [ 101,  [   99,     100,    101,    102,    99]],
        [ 102,  [   102,    101,    100,    99,     100]],
        [ 103,  [   104,    106,    106,    104,    105]],
        [ 104,  [   103,    103,    105,    105,    106]],
        [ 105,  [   106,    104,    104,    106,    103]],
        [ 106,  [   105,    105,    103,    103,    104]],
