...
namespace TinyWars.Utility.Notify {
    ...
    export const enum Type {
        ...
        SChatGetAllMessages,
        SChatAddMessage,
        SChatUpdateReadProgress,
        SChatGetAllReadProgressList,

        MsgUserGetPublicInfo,
        MsgUserGetPublicInfoFailed,
        MsgUserChangeNickname,
        MsgUserChangeNicknameFailed,
        MsgUserChangeDiscordId,
        MsgUserChangeDiscordIdFailed,
        SUserGetOnlineUsers,
        ...
        SMcrCreateRoom,
        SMcrGetRoomInfo,
        SMcrGetRoomInfoFailed,
        SMcrGetJoinedRoomInfoList,
        SMcrGetUnjoinedRoomInfoList,
        SMcwCommonGetWarInfoList,
        SMcrExitRoom,
        SMcrSetWarRule,
        SMcrJoinRoom,
        SMcrDestroyRoom,
        ...
        SMcrSetSelfSettings,
        SMcrStartWar,
        SMcwCommonContinueWarFailed,
        SMcwCommonContinueWar,
        SMcrGetReplayInfos,
        SMcrGetReplayData,
