...
export class UiScrollList<DataForRenderer> extends eui.Scroller {
    ...
    private _cachedItemRenderer         : (new () => UiListItemRenderer<DataForRenderer>) | undefined;
    ...
    public setItemRenderer(itemRenderer: new () => UiListItemRenderer<DataForRenderer>): void {
        if (this.getIsOpening()) {
