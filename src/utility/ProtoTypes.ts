...
export declare interface IMessageContainer {
    ...
    /** MessageContainer C_McwCommonHandleBoot */
    C_McwCommonHandleBoot?: (IC_McwCommonHandleBoot|null);
...
export declare class MessageContainer implements IMessageContainer {
    ...
    /** MessageContainer C_McwCommonHandleBoot. */
    public C_McwCommonHandleBoot?: (IC_McwCommonHandleBoot|null);
...
export declare interface IC_McrGetReplayInfos {
    ...
    /** C_McrGetReplayInfos userNickname */
    userNickname?: (string|null);

    /** C_McrGetReplayInfos coName */
    coName?: (string|null);
}
...
/** Properties of a C_McwCommonHandleBoot. */
export declare interface IC_McwCommonHandleBoot {

    /** C_McwCommonHandleBoot warId */
    warId?: (number|null);
}

/** Represents a C_McwCommonHandleBoot. */
export declare class C_McwCommonHandleBoot implements IC_McwCommonHandleBoot {

    /**
     * Constructs a new C_McwCommonHandleBoot.
     * @param [properties] Properties to set
     */
    constructor(properties?: IC_McwCommonHandleBoot);

    /** C_McwCommonHandleBoot warId. */
    public warId: number;

    /**
     * Creates a new C_McwCommonHandleBoot instance using the specified properties.
     * @param [properties] Properties to set
     * @returns C_McwCommonHandleBoot instance
     */
    public static create(properties?: IC_McwCommonHandleBoot): C_McwCommonHandleBoot;

    /**
     * Encodes the specified C_McwCommonHandleBoot message. Does not implicitly {@link C_McwCommonHandleBoot.verify|verify} messages.
     * @param message C_McwCommonHandleBoot message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: IC_McwCommonHandleBoot, writer?: protobuf.Writer): protobuf.Writer;

    /**
     * Encodes the specified C_McwCommonHandleBoot message, length delimited. Does not implicitly {@link C_McwCommonHandleBoot.verify|verify} messages.
     * @param message C_McwCommonHandleBoot message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encodeDelimited(message: IC_McwCommonHandleBoot, writer?: protobuf.Writer): protobuf.Writer;

    /**
     * Decodes a C_McwCommonHandleBoot message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns C_McwCommonHandleBoot
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: (protobuf.Reader|Uint8Array), length?: number): C_McwCommonHandleBoot;

    /**
     * Decodes a C_McwCommonHandleBoot message from the specified reader or buffer, length delimited.
     * @param reader Reader or buffer to decode from
     * @returns C_McwCommonHandleBoot
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: (protobuf.Reader|Uint8Array)): C_McwCommonHandleBoot;

    /**
     * Verifies a C_McwCommonHandleBoot message.
     * @param message Plain object to verify
     * @returns `null` if valid, otherwise the reason why it is not
     */
    public static verify(message: { [k: string]: any }): (string|null);
    ...
    /**
     * Creates a C_McwCommonHandleBoot message from a plain object. Also converts values to their respective internal types.
     * @param object Plain object
     * @returns C_McwCommonHandleBoot
     */
    public static fromObject(object: { [k: string]: any }): C_McwCommonHandleBoot;

    /**
     * Creates a plain object from a C_McwCommonHandleBoot message. Also converts values to other types if specified.
     * @param message C_McwCommonHandleBoot
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: C_McwCommonHandleBoot, options?: protobuf.IConversionOptions): { [k: string]: any };

    /**
     * Converts this C_McwCommonHandleBoot to JSON.
     * @returns JSON object
     */
    public toJSON(): { [k: string]: any };
}

/** Properties of a S_McwCommonHandleBoot. */
export declare interface IS_McwCommonHandleBoot {

    /** S_McwCommonHandleBoot errorCode */
    errorCode?: (number|null);

    /** S_McwCommonHandleBoot warId */
    warId?: (number|null);
}

/** Represents a S_McwCommonHandleBoot. */
export declare class S_McwCommonHandleBoot implements IS_McwCommonHandleBoot {

    /**
     * Constructs a new S_McwCommonHandleBoot.
     * @param [properties] Properties to set
     */
    constructor(properties?: IS_McwCommonHandleBoot);
    ...
    /**
     * Creates a new S_McwCommonHandleBoot instance using the specified properties.
     * @param [properties] Properties to set
     * @returns S_McwCommonHandleBoot instance
     */
    public static create(properties?: IS_McwCommonHandleBoot): S_McwCommonHandleBoot;

    /**
     * Encodes the specified S_McwCommonHandleBoot message. Does not implicitly {@link S_McwCommonHandleBoot.verify|verify} messages.
     * @param message S_McwCommonHandleBoot message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: IS_McwCommonHandleBoot, writer?: protobuf.Writer): protobuf.Writer;

    /**
     * Encodes the specified S_McwCommonHandleBoot message, length delimited. Does not implicitly {@link S_McwCommonHandleBoot.verify|verify} messages.
     * @param message S_McwCommonHandleBoot message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encodeDelimited(message: IS_McwCommonHandleBoot, writer?: protobuf.Writer): protobuf.Writer;

    /**
     * Decodes a S_McwCommonHandleBoot message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns S_McwCommonHandleBoot
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: (protobuf.Reader|Uint8Array), length?: number): S_McwCommonHandleBoot;

    /**
     * Decodes a S_McwCommonHandleBoot message from the specified reader or buffer, length delimited.
     * @param reader Reader or buffer to decode from
     * @returns S_McwCommonHandleBoot
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: (protobuf.Reader|Uint8Array)): S_McwCommonHandleBoot;

    /**
     * Verifies a S_McwCommonHandleBoot message.
     * @param message Plain object to verify
     * @returns `null` if valid, otherwise the reason why it is not
     */
    public static verify(message: { [k: string]: any }): (string|null);
    ...
    /**
     * Creates a S_McwCommonHandleBoot message from a plain object. Also converts values to their respective internal types.
     * @param object Plain object
     * @returns S_McwCommonHandleBoot
     */
    public static fromObject(object: { [k: string]: any }): S_McwCommonHandleBoot;

    /**
     * Creates a plain object from a S_McwCommonHandleBoot message. Also converts values to other types if specified.
     * @param message S_McwCommonHandleBoot
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: S_McwCommonHandleBoot, options?: protobuf.IConversionOptions): { [k: string]: any };
